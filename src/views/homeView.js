...
<div class="flex  min-h-screen">
    <aside id="sidebar" class="bg-white w-72 min-h-screen shadow-2xl border-r border-gray-200 p-6 flex flex-col justify-between hidden lg:flex">
        <div>
...
export default function homeView(){
    return `
      <div class="bg-white rounded-2xl p-6 shadow-sm mb-8 border border-gray-200">
        ...
        <div id="homeCard" class="grid grid-cols-3 gap-6">
    </div>
